...
echo "  npx skills add op0ai/usectx  # SKILL.md into project (Cursor / Claude / Codex / …)"
echo "  Stranger MCP-only: copy examples/cursor.mcp.json → .cursor/mcp.json (paste bearer)"
if [[ "${scope}" != "global" ]]; then
